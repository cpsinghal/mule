...
import org.mule.extension.api.introspection.property.display.DisplayModelProperty;
import org.mule.metadata.api.ClassTypeLoader;
import org.mule.metadata.api.model.MetadataType;
import org.mule.metadata.java.utils.JavaTypeUtils;
import org.mule.module.extension.internal.model.property.DeclaringMemberModelProperty;
import org.mule.module.extension.internal.model.property.display.DisplayModelPropertyBuilder;
...
public final class MuleExtensionAnnotationParser
{
    ...
    public static void parsePlacementAnnotation(AnnotatedElement annotatedElement, DisplayModelPropertyBuilder builder)
    {
    ...
    public static void parseDisplayNameAnnotation(AnnotatedElement annotatedElement, String fieldName, DisplayModelPropertyBuilder builder)
    {
    ...
    public static void parseDisplayAnnotations(AnnotatedElement annotatedElement, String name, ParameterDescriptor parameter)
    {
        parseDisplayAnnotations(annotatedElement, name, parameter, DisplayModelPropertyBuilder.create());
    }

    public static void parseDisplayAnnotations(AnnotatedElement annotatedElement, String name, ParameterDescriptor parameter, DisplayModelPropertyBuilder builder)
    {
        ...
        parameter.withModelProperty(DisplayModelProperty.KEY, builder.build());
    }
