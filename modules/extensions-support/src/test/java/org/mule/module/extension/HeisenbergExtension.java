...
public class HeisenbergExtension implements Lifecycle, MuleContextAware
{
    ...
    public static final String PARAMETER_ORIGINAL_OVERRIDED_DISPLAY_NAME = "displayNameParameter";

    public static final String PARAMETER_GENERATED_DISPLAY_NAME = "Test How Display Name Is Generated When Not Overrided";
    public static final String PARAMETER_ORIGINAL_GENERATED_DISPLAY_NAME = "testHowDisplayNameIsGeneratedWhenNotOverrided";
    ...
    private String displayNameParameter;

    @Parameter
    @Optional
    private String testHowDisplayNameIsGeneratedWhenNotOverrided;
